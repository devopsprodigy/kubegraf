define(["app/core/app_events","app/core/utils/kbn","app/plugins/sdk"], function(__WEBPACK_EXTERNAL_MODULE_grafana_app_core_app_events__, __WEBPACK_EXTERNAL_MODULE_grafana_app_core_utils_kbn__, __WEBPACK_EXTERNAL_MODULE_grafana_app_plugins_sdk__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
exports.__prepare = __prepare;
exports.__preparePods = __preparePods;
exports.__convertToGB = __convertToGB;
exports.__roundCpu = __roundCpu;
exports.__percentUsed = __percentUsed;
...
exports.PrometheusProxy = undefined;
...
function () {
  ...
  PrometheusProxy.prototype.query = function (query, debug) {
    ...
    var body = {
      range: {
        from: (0, _moment2.default)().subtract(2, 'minute'),
...
exports.PrometheusProxy = PrometheusProxy;
...
var _baseModel = __webpack_require__(/*! ../../common/types/traits/baseModel */ "./common/types/traits/baseModel.ts");
    ...
    get: function get() {
      switch (this.status) {
        case _constants.SUCCESS:
          return _constants.COLOR_GREEN;

        case _constants.ERROR:
          return _constants.COLOR_RED;
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(Cronjob, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(Daemonset, _super);
...
exports.Deployment = undefined;

var _tslib = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");

var _baseModel = __webpack_require__(/*! ./traits/baseModel */ "./common/types/traits/baseModel.ts");

var Deployment =
/** @class */
function (_super) {
  (0, _tslib.__extends)(Deployment, _super);
...
var _store = __webpack_require__(/*! ../../common/store */ "./common/store.ts");
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(Namespace, _super);
  ...
  Namespace.prototype.toggle = function () {
    ...
    var namespaceStore = _store2.default.getObject('namespaceStore');
    ...
    _store2.default.setObject('namespaceStore', namespaceStore);
  };
...
var _helpers = __webpack_require__(/*! ../helpers */ "./common/helpers.ts");
...
var _constants = __webpack_require__(/*! ../constants */ "./common/constants.ts");
...
function (_super) {
  ...
  function Node(data) {
    ...
    _this.hideNs = _store2.default.getBool(_this.name + 'NsList', false);
    return _this;
  }
  ...
  Node.prototype.toggle = function () {
    ...
    var nodeStore = _store2.default.getObject('nodeStore');
    ...
    _store2.default.setObject('nodeStore', nodeStore);
  };
  ...
  Object.defineProperty(Node.prototype, "memoryCapacityFormatted", {
    get: function get() {
      return (0, _helpers.__convertToGB)(this.__getBytes(this.data.status.capacity.memory));
    },
    enumerable: true,
    configurable: true
  });
  Object.defineProperty(Node.prototype, "memoryAllocatableFormatted", {
    get: function get() {
      return (0, _helpers.__convertToGB)(this.__getBytes(this.data.status.allocatable.memory));
    },
    enumerable: true,
    configurable: true
  });
  ...
  Object.defineProperty(Node.prototype, "memoryUsedFormatted", {
    /*used format*/
    get: function get() {
      return (0, _helpers.__convertToGB)(this.metrics.memoryUsed) + ' (' + (0, _helpers.__percentUsed)(this.metrics.memoryUsed, this.__getBytes(this.data.status.allocatable.memory)) + ')';
    },
    enumerable: true,
    configurable: true
  });
  Object.defineProperty(Node.prototype, "memoryRequestedFormatted", {
    get: function get() {
      return (0, _helpers.__convertToGB)(this.metrics.memoryRequested) + ' (' + (0, _helpers.__percentUsed)(this.metrics.memoryRequested, this.__getBytes(this.data.status.allocatable.memory)) + ')';
    },
    enumerable: true,
    configurable: true
  });
  ...
  Object.defineProperty(Node.prototype, "cpuUsedFormatted", {
    get: function get() {
      ...
      return (0, _helpers.__roundCpu)(this.metrics.cpuUsed) + ' (' + (0, _helpers.__percentUsed)(this.metrics.cpuUsed, cpu) + ')';
    },
    enumerable: true,
    configurable: true
  });
  ...
  Object.defineProperty(Node.prototype, "podsUsedFormatted", {
    get: function get() {
      return this.metrics.podsCount + ' (' + (0, _helpers.__percentUsed)(this.metrics.podsCount, this.data.status.allocatable.pods) + ')';
    },
    enumerable: true,
    configurable: true
  });
  ...
  Node.prototype.__getColor = function (status) {
    switch (status) {
      ...
      case _constants.WARNING:
        return _constants.COLOR_YELLOW;
      ...
      if (status === _constants.ERROR) {
        ...
        if (this.data.metadata.deletionTimestamp) {
          ...
          if (data.status.containerStatuses) {
            ...
            if (d != undefined) message = d.message;
          } else if (data.status.message) {
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(Service, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(Statefulset, _super);
...
function () {
  function BaseModel(data) {
    ...
    this.open = true;
    this.limit = _constants.PODS_LIMIT;
  }
...
exports.ApplicationsOverview = undefined;
...
var _k8sPage = __webpack_require__(/*! ../k8s-page */ "./components/k8s-page.ts");
...
function (_super) {
  ...
  ApplicationsOverview.prototype.toggleNamespace = function (namespace) {
    _store2.default.delete('namespaceStore');
...
exports.ApplicationsOverview = ApplicationsOverview;
...
exports.ClusterAlerts = undefined;
...
exports.ClusterAlerts = ClusterAlerts;
  ...
  ClusterConfig.prototype.testCluster = function () {
    ...
    this.backendSrv.datasourceRequest({
      ...
      if (response && response.status === 200) {
        ...
        _app_events2.default.emit('alert-error', ['Unhandled error']);
      }
    }, function (error) {
      if (error && error.status && error.statusText) {
        _app_events2.default.emit('alert-error', [error.status + ' ' + error.statusText]);
      } else {
        _app_events2.default.emit('alert-error', ['Unhandled error']);
      }
    });
...
exports.ClustersList = ClustersList;
...
var _pod = __webpack_require__(/*! ../common/types/pod */ "./common/types/pod.ts");

var _prometheusProxy = __webpack_require__(/*! ../common/proxies/prometheusProxy */ "./common/proxies/prometheusProxy.ts");

var _constants = __webpack_require__(/*! ../common/constants */ "./common/constants.ts");

var _component = __webpack_require__(/*! ../common/types/component */ "./common/types/component.ts");

var _service = __webpack_require__(/*! ../common/types/service */ "./common/types/service.ts");

var _job = __webpack_require__(/*! ../common/types/job */ "./common/types/job.ts");

var _cronjob = __webpack_require__(/*! ../common/types/cronjob */ "./common/types/cronjob.ts");

var _namespace = __webpack_require__(/*! ../common/types/namespace */ "./common/types/namespace.ts");

var _store = __webpack_require__(/*! ../common/store */ "./common/store.ts");

var _store2 = _interopRequireDefault(_store);

var _deployment = __webpack_require__(/*! ../common/types/deployment */ "./common/types/deployment.ts");

var _statefulset = __webpack_require__(/*! ../common/types/statefulset */ "./common/types/statefulset.ts");

var _daemonset = __webpack_require__(/*! ../common/types/daemonset */ "./common/types/daemonset.ts");

var _node = __webpack_require__(/*! ../common/types/node */ "./common/types/node.ts");
...
function () {
        ...
        switch (_b.label) {
          case 0:
            ...
            instance = nodes.reduce(function (accumulator, node) {
              return (0, _tslib.__spread)(accumulator, [node.name + "|" + node.hostIp + ":.+"]);
            }, []).join('|');
            return [4
            /*yield*/
          ...
          case 1:
            ...
            _loop_1 = function _loop_1(node) {
              ...
              info[node.name] = {
                ...
                ramTotal: datapoints[1] && (0, _helpers.__convertToGB)(datapoints[1].datapoint),
                swapTotal: datapoints[2] && (0, _helpers.__convertToGB)(datapoints[2].datapoint),
                rootFSTotal: datapoints[3] && (0, _helpers.__convertToGB)(datapoints[3].datapoint),
                sysLoad: datapoints[4] && datapoints[4].datapoint,
                uptime: datapoints[5] && (0, _helpers.__convertToHours)(datapoints[5].datapoint * 1000)
              };
            };

            try {
              for (nodes_1 = (0, _tslib.__values)(nodes), nodes_1_1 = nodes_1.next(); !nodes_1_1.done; nodes_1_1 = nodes_1.next()) {
  ...
  K8sPage.prototype.getNodeMap = function (withoutPods) {
    ...
    if (!withoutPods) _promises.push(this.getPods(true));
  ...
  K8sPage.prototype.getNodes = function () {
    ...
    return this.cluster.getNodes().then(function (nodes) {
      ...
      var getStore = _store2.default.getObject('nodeStore');
        ...
        node.namespaces.map(function (namespace) {
          namespace.pods.map(function (pod) {
            ...
            if (cpu !== undefined) {
              ...
              pod.metrics.cpuUsed = (0, _helpers.__convertToMicro)(cpu.datapoint.toFixed(3));
            }

            if (mem !== undefined) {
              pod.sourceMetrics.memoryUsed = mem.datapoint;
              pod.metrics.memoryUsed = (0, _helpers.__convertToGB)(mem.datapoint);
            }

            if (cpuReq !== undefined) {
              pod.sourceMetrics.cpuRequested = cpuReq.datapoint;
              pod.metrics.cpuRequested = (0, _helpers.__convertToMicro)((0, _helpers.__roundCpu)(cpuReq.datapoint));
            }
  ...
  K8sPage.prototype.getNamespaceMap = function () {
    ...
    this.cluster.getNamespaces().then(function (namespaces) {
      ...
      var getStore = _store2.default.getObject('namespaceStore');
      ...
      namespaces.forEach(function (namespace) {
        var ns = new _namespace.Namespace(namespace);
  ...
  K8sPage.prototype.attachDeployments = function () {
    ...
    return this.cluster.getDeployments().then(function (deployments) {
      deployments.forEach(function (item) {
        var deploy = new _deployment.Deployment(item);
  ...
  K8sPage.prototype.refreshDeployments = function () {
    ...
    this.cluster.getDeployments().then(function (newDeployments) {
      ...
      newDeployments = newDeployments.map(function (newDeployment) {
        return new _deployment.Deployment(newDeployment);
      });
  ...
  K8sPage.prototype.attachStatefulsets = function () {
    ...
    return this.cluster.getStatefulsets().then(function (statefulsets) {
      statefulsets.forEach(function (item) {
        ...
        var ss = new _statefulset.Statefulset(item);
  ...
  K8sPage.prototype.refreshStatefulsets = function () {
    ...
    this.cluster.getStatefulsets().then(function (Statefulsets) {
      ...
      Statefulsets = Statefulsets.map(function (newStatefulset) {
        return new _statefulset.Statefulset(newStatefulset);
      });
  ...
  K8sPage.prototype.attachDaemonsets = function () {
    ...
    return this.cluster.getDaemonsets().then(function (daemonsets) {
      daemonsets.forEach(function (item) {
        ...
        var ds = new _daemonset.Daemonset(item);
  ...
  K8sPage.prototype.refreshDaemonsets = function () {
    ...
    this.cluster.getDaemonsets().then(function (Daemonsets) {
      ...
      Daemonsets = Daemonsets.map(function (newDaemonset) {
        return new _daemonset.Daemonset(newDaemonset);
      });
    ...
    return pods.filter(function (item) {
      ...
      if (labels == undefined) {
        ...
        for (var prop in filter) {
          if (!labels.hasOwnProperty(prop)) return false;
          if (labels[prop] != filter[prop]) return false;
        }
      }
  ...
  K8sPage.prototype.__findServices = function (entity) {
    ...
    return this.storeServices.filter(function (item) {
      if (!item.data.spec || !item.data.spec.selector) return false;
  ...
  K8sPage.prototype.getPrometheusDS = function (name) {
    ...
    return this.datasourceSrv.get(name).then(function (ds) {
      _this.prometheusDS = new _prometheusProxy.PrometheusProxy(ds);
    });
  };
      ...
      if (pods instanceof Array) {
        ...
        if (skipEmptyHost) {
          pods = pods.filter(function (pod) {
            return pod.status.hostIP != undefined;
          });
        }

        _this.storePods = pods.map(function (pod) {
          return new _pod.Pod(pod);
        });
  ...
  K8sPage.prototype.refreshPods = function (skipEmptyHost) {
    ...
    this.cluster.getPods().then(function (pods) {
      if (pods instanceof Array) {
        _this.podsError = false;
        if (skipEmptyHost) pods = pods.filter(function (pod) {
          return pod.status.hostIP != undefined;
        });
  ...
  K8sPage.prototype.getAllServices = function () {
    ...
    return this.cluster.getServices().then(function (services) {
      _this.storeServices = services.map(function (service) {
        return new _service.Service(service);
      });
    });
  };
  ...
  K8sPage.prototype.getClusterCronJobs = function () {
    ...
    return this.cluster.getCronJobs().then(function (cronjobs) {
      _this.storeCronJobs = cronjobs.map(function (cronjob) {
        return new _cronjob.Cronjob(cronjob);
      });
    });
  };
    ...
    if (warningPods.length > 0 && warningPods.filter(function (pod) {
      ...
      this.storePods.forEach(function (pod, index) {
        if (_this.podIsWarning(pod) && pod.message === "Undefined error" && _this.storeEvents) {
          var event_1 = _this.storeEvents.find(function (event) {
  ...
  K8sPage.prototype.getWarningNodes = function () {
    return this.nodesMap.filter(function (item) {
      return item.status === _constants.ERROR;
    });
  };
...
exports.NodesOverview = undefined;
...
function (_super) {
  ...
  NodesOverview.prototype.summary = function (ns, metric) {
    ...
    switch (metric) {
      case "cpuUsed":
        return (0, _helpers.__convertToMicro)(res.toFixed(3));
  ...
  NodesOverview.prototype.toggleNodes = function (node) {
    _store2.default.delete('nodeStore');
...
exports.DOPKubeGrafAppConfig = DOPKubeGrafAppConfig;
...
var _nodesOverview = __webpack_require__(/*! ./components/nodes-overview/nodes-overview */ "./components/nodes-overview/nodes-overview.ts");

var _clusterAlerts = __webpack_require__(/*! ./components/cluster-alerts/cluster-alerts */ "./components/cluster-alerts/cluster-alerts.ts");

var _config = __webpack_require__(/*! ./config/config */ "./config/config.ts");
...
exports.ConfigCtrl = _config.DOPKubeGrafAppConfig;
